...
export default function DataAnalyst() {
  ...
  const curriculumItems = [
    {
      ...
      content: ["Introduction to Data Analytics", "Data Types & Data Lifecycle", "Business Analytics Concepts","Analytical Thinking"],
      position: "right",
    },
    {
      number: "02",
      title: "Excel for Data Analytics",
      content: ["Advanced Excel Functions", "Data Cleaning Techniques", "Pivot Tables & Pivot Charts","Dashboard Creation"],
      position: "left",
    },
    {
      number: "03",
      title: "SQL For Data Management",
      content: ["SQL Basics", "Database Design Concepts", "Data Retrieval Queries","Joins & Subqueries","Data Aggregation"],
      position: "right",
    },
    {
      number: "04",
      title: "Data Visualization Tools",
      content: ["Power BI", "Tableau", "Dashboard Development","Business Reporting"],
      position: "left",
    },
    {
      number: "05",
      title: "Real-World Projects",
      content: ["Sales Data Analysis", "Customer Behavior Analysis", "Financial Data Insights","Business KPI Dashboard"],
      position: "right",
    },
    {
      number: "06",
      title: "Interview Preperations",
      content: ["Resume Building", "Portfolio Development", "Mock Interviews","Placement Support"],
      position: "left",
    },
  ...
  const reviews = [
    ...
    },
    {
      name: "Riyas",
      image: "https://randomuser.me/api/portraits/men/32.jpg",
      review:"From Non-IT to Data Analyst 🚀📊 | CareerschoolIf he can do it, YOU can too!Start your journey towards a high-growth tech career today." ,
      linkedin:"https://www.linkedin.com/posts/careerschool-dataanalytics-dashboard-ugcPost-7405164691603382272-wLVA?utm_source=share&utm_medium=member_desktop&rcm=ACoAADyT6p4BnuGXSZWAph-ReTQElDyDqUml-ks",
    },
      ...
      <table className="w-full bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <tbody className="text-sm md:text-base">
          ...
          <tr className="border text-center">
            <td className="p-3 md:p-4 text-left">Industry Focused Curriculum</td>
          ...
          <tr className="border text-center">
            <td className="p-3 md:p-4 text-left">Real-World Projects</td>
            <td className="text-green-600 font-semibold">✔ YES</td>
            <td className="bg-red-100 text-red-600 font-semibold px-3 md:px-4 py-2 md:py-3 rounded">
              ✘ Few
            </td>
          ...
          <tr className="border text-center">
            <td className="p-3 md:p-4 text-left">Placement Assistance</td>
            <td className="text-green-600 font-semibold">✔ Dedicated Support</td>
            <td className="bg-red-100 text-red-600 font-semibold px-3 md:px-4 py-2 md:py-3 rounded">
              ✘ Not Available
              </td>
          </tr>
          ...
          <tr className="border text-center">
            <td className="p-3 md:p-4 text-left">Experienced Trainers</td>
            <td className="text-green-600 font-semibold">✔ Industry Experts</td>
          <td className="bg-red-100 text-red-600 font-semibold px-3 md:px-4 py-2 md:py-3 rounded">
            ✘ Mostly Theoretical
            </td>
          </tr>
          ...
          <tr className="border text-center">
            <td className="p-3 md:p-4 text-left">Interview Preparation</td>
            <td className="text-green-600 font-semibold">✔ Mock Interviews</td>
            <td className="bg-red-100 text-red-600 font-semibold px-3 md:px-4 py-2 md:py-3 rounded">
              ✘ Basic Guidance
            </td>
          </tr>
          ...
          <tr className="border text-center">
            ...
            <td className="text-green-600 font-semibold">✔ Hands-on Training</td>
            <td className="bg-red-100 text-red-600 font-semibold px-3 md:px-4 py-2 md:py-3 rounded">
              ✘ Heavy Theory
              </td>
          </tr>
          ...
          <tr className="border text-center">
            <td className="p-3 md:p-4 text-left">Live Classroom Training</td>
            <td className="text-green-600 font-semibold">✔ YES</td>
            <td className="bg-red-100 text-red-600 font-semibold px-3 md:px-4 py-2 md:py-3 rounded">
