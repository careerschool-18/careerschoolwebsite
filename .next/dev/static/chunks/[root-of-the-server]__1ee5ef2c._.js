...
"[project]/pages/test/web-development.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

// pages/test/web-development
__turbopack_context__.s([
    "default",
    ()=>WebDevelopmentTest
]);
...
(()=>{
    const e = new Error("Cannot find module '../../data/web-development.json'");
...
;
;
const STORAGE_KEY = "web_development_test_state_v1";
function WebDevelopmentTest() {
    _s();
    ...
    /* ---------------- SECURITY BLOCKS ---------------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WebDevelopmentTest.useEffect": ()=>{
            if (step !== "test") return;
            const block = {
                "WebDevelopmentTest.useEffect.block": (e)=>e.preventDefault()
            }["WebDevelopmentTest.useEffect.block"];
            const blockKeys = {
                "WebDevelopmentTest.useEffect.blockKeys": (e)=>{
                    ...
                    if (forbidden) {
                        triggerAutoSubmit("You violated the exam rules, so the Web Development test was automatically submitted. Kindly contact HR.");
                    }
                }
            }["WebDevelopmentTest.useEffect.blockKeys"];
    ...
    /* ---------------- TIMER ---------------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WebDevelopmentTest.useEffect": ()=>{
            ...
            const interval = setInterval({
                "WebDevelopmentTest.useEffect.interval": ()=>{
                    setTimer({
                        "WebDevelopmentTest.useEffect.interval": (prev)=>{
                            if (prev <= 1) {
                                triggerAutoSubmit("The time is over, so the Web Development test was automatically submitted. Please contact HR for further details.");
            ...
            }["WebDevelopmentTest.useEffect.interval"], 1000);
            return ({
                "WebDevelopmentTest.useEffect": ()=>clearInterval(interval)
            })["WebDevelopmentTest.useEffect"];
        }
    }["WebDevelopmentTest.useEffect"], [
        step
    ...
    /* ---------------- TAB SWITCH ---------------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WebDevelopmentTest.useEffect": ()=>{
            ...
            const handleVisibility = {
                "WebDevelopmentTest.useEffect.handleVisibility": ()=>{
                    if (document.visibilityState === "hidden") {
                        setTabCount({
                            "WebDevelopmentTest.useEffect.handleVisibility": (prev)=>{
                                const count = prev + 1;
                                if (count <= 2) {
                                    alert(`Warning ${count}/3: Tab switching is not allowed.`);
                                    return count;
                                }
                                triggerAutoSubmit("You violated the rules 3 times, so the Web Development test was submitted. Kindly contact HR.");
                                return count;
                            }
                        }["WebDevelopmentTest.useEffect.handleVisibility"]);
                    }
            ...
            return ({
                "WebDevelopmentTest.useEffect": ()=>document.removeEventListener("visibilitychange", handleVisibility)
            })["WebDevelopmentTest.useEffect"];
        }
    }["WebDevelopmentTest.useEffect"], [
        step
    ...
    /* ---------------- SUBMITTED ---------------- */ if (step === "submitted") {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CenteredCard, {
            title: "Web Development Test Submitted",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    className: "text-center text-red-600 font-semibold mb-6",
                    children: autoSubmitReason || "Your Web Development test was successfully submitted."
                }, void 0, false, {
                    fileName: "[project]/pages/test/web-development.js",
                    lineNumber: 166,
                    columnNumber: 9
                }, this),
    ...
    /* ---------------- INSTRUCTIONS ---------------- */ if (step === "instructions") {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CenteredCard, {
            title: "Web Development Test Instructions",
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PrimaryButton, {
                    className: "mt-6",
                    onClick: ()=>window.open("/test/web-development?start=true", "_blank"),
                    children: "Start Web Development Test"
                }, void 0, false, {
                    fileName: "[project]/pages/test/web-development.js",
                    lineNumber: 190,
                    columnNumber: 9
    ...
    /* ---------------- LOGIN ---------------- */ if (step === "login") {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CenteredCard, {
            title: "Web Development Online Assessment",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        children: "Submit Web Development Test"
                    }, void 0, false, {
                        fileName: "[project]/pages/test/web-development.js",
                        lineNumber: 257,
                        columnNumber: 9
...
_s(WebDevelopmentTest, "k503SsbTVcKAmIrbOrTe4ABWVEw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = WebDevelopmentTest;
...
__turbopack_context__.k.register(_c, "WebDevelopmentTest");
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/pages/test/web-development.js [client] (ecmascript)\" } [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const PAGE_PATH = "/test/web-development";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/pages/test/web-development.js [client] (ecmascript)");
    }
]);
...
"[hmr-entry]/hmr-entry.js { ENTRY => \"[project]/pages/test/web-development.js\" }", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/pages/test/web-development.js [client] (ecmascript)\" } [client] (ecmascript)");
}),
]);

//# sourceMappingURL=%5Broot-of-the-server%5D__1ee5ef2c._.js.map