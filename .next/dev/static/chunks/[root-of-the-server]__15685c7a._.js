...
function PythonTest() {
    ...
    /* ---------------- FETCH PYTHON QUESTIONS ---------------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PythonTest.useEffect": ()=>{
            if (router.query.start === "true") {
                fetch(`/api/getQuestions?category=python`).then({
                    "PythonTest.useEffect": (res)=>res.json()
                }["PythonTest.useEffect"]).then({
                    "PythonTest.useEffect": (data)=>{
...
_s(PythonTest, "7spXyUwcYvrQo6oQbEj5FWSIWEc=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__15685c7a._.js.map