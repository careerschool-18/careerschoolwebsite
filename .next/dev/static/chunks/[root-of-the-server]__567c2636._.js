...
function JavaTest() {
    ...
    /* ---------------- FETCH JAVA QUESTIONS FROM BACKEND ---------------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "JavaTest.useEffect": ()=>{
            if (router.query.start === "true") {
                fetch(`/api/v1/questions?category=java`).then({
                    "JavaTest.useEffect": (res)=>res.json()
                }["JavaTest.useEffect"]).then({
                    "JavaTest.useEffect": (data)=>{
...
_s(JavaTest, "7spXyUwcYvrQo6oQbEj5FWSIWEc=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__567c2636._.js.map