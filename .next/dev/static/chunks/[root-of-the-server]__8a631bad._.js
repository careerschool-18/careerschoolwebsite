...
function AptitudeTest() {
    ...
    /* ---------------- FETCH QUESTIONS FROM JAVA BACKEND ---------------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AptitudeTest.useEffect": ()=>{
            if (router.query.start === "true") {
                fetch("https://your-java-backend.com/api/v1/questions?category=aptitude").then({
                    "AptitudeTest.useEffect": (res)=>res.json()
                }["AptitudeTest.useEffect"]).then({
                    "AptitudeTest.useEffect": (data)=>{
                        if (!Array.isArray(data) || data.length === 0) {
                            alert("No aptitude questions found.");
                            router.push("/");
                            return;
                        }
                        setQuestions(data);
            ...
            const blockKeys = {
                "AptitudeTest.useEffect.blockKeys": (e)=>{
                    if (e.key === "F12" || e.ctrlKey && e.shiftKey && [
                        ...
                        triggerAutoSubmit("Rule violation detected.");
                    }
                }
    ...
    /* ---------------- TAB SWITCH DETECTION ---------------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AptitudeTest.useEffect": ()=>{
            if (step !== "test") return;
                    ...
                    if (document.visibilityState === "hidden") {
                        setTabCount({
                            "AptitudeTest.useEffect.handleVisibility": (prev)=>{
                                const count = prev + 1;
                                if (count <= 2) alert(`Warning ${count}/3: Tab switching not allowed.`);
                                if (count >= 3) triggerAutoSubmit("Multiple tab switches detected.");
                                return count;
                            }
                        }["AptitudeTest.useEffect.handleVisibility"]);
                    }
    ...
    /* ---------------- SUBMIT TEST TO JAVA BACKEND ---------------- */ const submitTest = async (forced = false)=>{
        ...
        try {
            await fetch(`${BACKEND_URL}/api/v1/tests`, {
                method: "POST",
                headers: {
    ...
    /* ---------------- SUBMITTED SCREEN ---------------- */ if (step === "submitted") {
    ...
    /* ---------------- TEST UI ---------------- */ return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                [
                                    ...
                                    q.option_d
                                        ...
                                        className: `w-full px-4 py-2 mb-2 border rounded ${answers[q.id] === opt ? "bg-blue-600 text-white" : "bg-white"}`,
                                        children: opt
                                    }, opt, false, {
                                        fileName: "[project]/pages/test/aptitude.js",
                                        lineNumber: 187,
...
_s(AptitudeTest, "7spXyUwcYvrQo6oQbEj5FWSIWEc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = AptitudeTest;
const CenteredCard = ({ title, children })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "min-h-screen flex items-center justify-center bg-gray-100 px-3",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "bg-white p-6 rounded-xl shadow w-full max-w-lg text-center",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8a631bad._.js.map