...
"[project]/pages/test/aptitude.js [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AptitudeTest() {
    ...
    /* ---------------- FETCH QUESTIONS FROM JAVA BACKEND ---------------- */ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        if (router.query.start === "true") {
            fetch("https://your-java-backend.com/api/v1/questions?category=aptitude").then((res)=>res.json()).then((data)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__87f9eaa3._.js.map