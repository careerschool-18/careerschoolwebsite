...
function JavaTest() {
    ...
    /* ---------------- FETCH JAVA QUESTIONS FROM BACKEND ---------------- */ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        if (router.query.start === "true") {
            fetch(`/api/v1/questions?category=java`).then((res)=>res.json()).then((data)=>{
                if (!Array.isArray(data) || data.length === 0) {
                    alert("No Java questions found.");
                    router.push("/");
                    return;
                }
                setQuestions(data);
    ...
    /* ---------------- SUBMIT TEST TO BACKEND ---------------- */ const submitTest = async (forced = false)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__349272d1._.js.map