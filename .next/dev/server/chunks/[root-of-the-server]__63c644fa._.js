...
"[project]/pages/api/saveResult.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    try {
        const { studentId, answers, questions, category } = req.body;
        if (!studentId || !questions) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].query("INSERT INTO results (student_id, category, score, submitted_at) VALUES (?, ?, ?, NOW())", [
            studentId,
            category,
            score
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__63c644fa._.js.map